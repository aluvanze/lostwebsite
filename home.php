...
<body>
    ...
    <div class="page-wrapper">
         ...
         <div class="post-slider">
            <h1 class="slider-title">Lost Items</h1>
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="post">';
   echo '<img src="images/'.$row['image'].'" alt="" class="slider-image">';

    echo '<div class="post-info">';
    echo '<h4><a href="single.html">'.$row['title'].'</a></h4>';

    echo '<i class="far fa-calendar">'.$row['created_at'].'</i>';
    echo '</div></div>';
  }
  ?>
